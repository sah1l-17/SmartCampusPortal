...
const StudentAttendance = () => {
  ...
  const overallStats = attendanceData.reduce(
    (acc, course) => {
      acc.totalClasses += course.totalClasses || 0
      acc.totalPresent += (course.presentCount || 0) + (course.lateCount || 0)
      acc.totalAbsent += course.absentCount || 0
      return acc
    },
        ...
        {filteredData.map((course) => (
          <div key={course.courseId} className="card">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <p className="text-2xl font-bold text-gray-900">{course.attendancePercentage || 0}%</p>
              ...
              <div className="mt-4 grid grid-cols-4 gap-4">
                <div className="text-center">
                  ...
                  <p className="text-lg font-semibold text-gray-900">{course.totalClasses || 0}</p>
                </div>
                <div className="text-center">
                  <p className="text-sm text-gray-600">Present</p>
                  <p className="text-lg font-semibold text-green-600">{course.presentCount || 0}</p>
                </div>
                <div className="text-center">
                  <p className="text-sm text-gray-600">Late</p>
                  <p className="text-lg font-semibold text-yellow-600">{course.lateCount || 0}</p>
                </div>
                <div className="text-center">
                  <p className="text-sm text-gray-600">Absent</p>
                  <p className="text-lg font-semibold text-red-600">{course.absentCount || 0}</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6">
              ...
              {course.records && course.records.length > 0 ? (
